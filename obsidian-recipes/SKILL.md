...
2. If the input is a URL, attempt to crawl the URL and extract the recipe. If this is not possible using your available tools, stop and report the failure to the user
